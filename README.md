...
Claude: 내용을 보니 경영진 보고 문서에 가깝습니다.
        → executive-summary (대표보고 요약) 을 추천합니다.
           meeting-minutes (회의록) 도 선택 가능합니다.
        어떤 템플릿으로 진행할까요?
```
...
| ID | 이름 | 용도 | 페이지 수 |
|----|------|------|-----------|
| `executive-summary` | 대표보고 요약 | 경영진·대표 대상 핵심 사안, 의사결정 보고 | A4 2~4쪽 |
| `meeting-minutes` | 회의록 | 논의 내용, 결정 사항, 액션아이템 기록 | A4 3~5쪽 |
| `custom` | 커스텀 | 섹션 풀에서 필요한 구성 요소 자유 조합 | 제한 없음 |
